    ...
    <div class="container">
        <asp:Panel ID="pnlModule" runat="server" Visible="false">
            <div class="module-header">
                ...
                <p><asp:Label ID="lblModuleDescription" runat="server"></asp:Label></p>
                ...
                <div class="col-sidebar">
                    <div class="card">
                        ...
                        <div class="progress-large">
                            <div class="progress">
                                <div class="progress-bar" style="width: <asp:Label ID="lblProgressPercent" runat="server" Text="0"></asp:Label>%">
