...
namespace RespondX.Learner
{
    public partial class Lesson : Page
    {
        ...
        private void LoadLesson(int lessonId)
        {
            ...
            lblModuleTitle.Text = lesson.ModuleTitle;
            lblModuleId.Text = lesson.ModuleId.ToString();
            ...
            lblStatusBadge.Text = lesson.IsCompleted ? "badge-success" : "badge-warning";
        ...
        protected void btnMarkComplete_Click(object sender, EventArgs e)
        {
            ...
            lblStatusBadge.Text = "badge-success";
